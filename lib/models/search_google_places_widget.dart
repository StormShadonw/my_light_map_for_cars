...
import 'package:my_light_map_for_cars/models/geocode.dart';
...
class SearchGooglePlacesWidget extends StatefulWidget {
  ...
  /// Height for the container, default is 75.
...
class _SearchMapPlaceWidgetState extends State<SearchGooglePlacesWidget>
  ...
  void initState() {
    ...
    _containerHeight = Tween<double>(
            begin: widget.containerHeight ?? 75,
            end: (widget.containerHeight ?? 75) * 7.5)
        .animate(
      CurvedAnimation(
